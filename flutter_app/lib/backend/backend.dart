...
import 'schema/voice_audios_record.dart';
...
export 'schema/voice_audios_record.dart';
...
/// Functions to query VoiceAudiosRecords (as a Stream and as a Future).
Future<int> queryVoiceAudiosRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VoiceAudiosRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VoiceAudiosRecord>> queryVoiceAudiosRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      VoiceAudiosRecord.collection(parent),
      VoiceAudiosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VoiceAudiosRecord>> queryVoiceAudiosRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<int> queryGenerationsRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      GenerationsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Future<int> queryTranslationsRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      TranslationsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
